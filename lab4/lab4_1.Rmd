...
colMeans(x)
```
_First two lines of code here are how I would've done it_
...
Imported data frames often have a mix of lower and uppercase column names. Use `select_all()` with `toupper` or `tolower`  to fix this issue. I always try to use lowercase to keep things consistent.  
