...
fish %>% 
  ...
  filter(lakeid == "AR"| lakeid == "AL", between(radii_length_mm,2,4)) 
...
We will briefly introduce `if_else()` here because it allows us to use `mutate()` but not affect the entire column in the same way. In a sense, this can function like find and replace in a spreadsheet program. 
